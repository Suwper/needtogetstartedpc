    ...
    awful.button({ }, 3, function ()
        ...
        return function ()
            if instance and instance.wibox.visible then
                ...
                instance = awful.menu.clients({theme = {width = dpi(200)}})
            end
        end
    end),
...
globalkeys = my_table.join(
    ...
    --discord
    awful.key({ modkey }, "`", function () awful.spawn.with_shell("discord") end,
      {description = discord, group = "function keys"}),
    
    awful.key({ modkey, "Shift" }, "m", function () awful.spawn.with_shell("minecraft-launcher") end,
	    {description = minecraft, group = "function keys"}),    
   ...
   -- awful.key({ modkey, "Shift" }, "Return", function() awful.util.spawn( filemanager ) end),
    ...
    awful.key({ modkey }, "f", function() awful.util.spawn( filemanager ) end,
      {description = "file manager", group = "function keys"}),
